...
class WP_Locale {
  ...
  function init() {
    // The Weekdays
    $this->weekday[0] = /* translators: weekday */ __('Pühapäev');
    $this->weekday[1] = /* translators: weekday */ __('Esmaspäev');
    $this->weekday[2] = /* translators: weekday */ __('Teisipäev');
    $this->weekday[3] = /* translators: weekday */ __('Kolmapäev');
    $this->weekday[4] = /* translators: weekday */ __('Neljapäev');
    $this->weekday[5] = /* translators: weekday */ __('Reede');
    $this->weekday[6] = /* translators: weekday */ __('Laupäev');

    // The first letter of each day. The _%day%_initial suffix is a hack to make
    // sure the day initials are unique.
    $this->weekday_initial[__('Pühapäev')]    = /* translators: one-letter abbreviation of the weekday */ __('P_Pühapäev_initial');
    $this->weekday_initial[__('Esmaspäev')]    = /* translators: one-letter abbreviation of the weekday */ __('E_Esmaspäev_initial');
    $this->weekday_initial[__('Teisipäev')]   = /* translators: one-letter abbreviation of the weekday */ __('T_Teisipäev_initial');
    $this->weekday_initial[__('Kolmapäev')] = /* translators: one-letter abbreviation of the weekday */ __('K_Kolmapäev_initial');
    $this->weekday_initial[__('Neljapäev')]  = /* translators: one-letter abbreviation of the weekday */ __('N_Neljapäev_initial');
    $this->weekday_initial[__('Reede')]    = /* translators: one-letter abbreviation of the weekday */ __('R_Reede_initial');
    $this->weekday_initial[__('Laupäev')]  = /* translators: one-letter abbreviation of the weekday */ __('L_Laupäev_initial');
    ...
    // The Months
    $this->month['01'] = /* translators: month name */ __('Jaanuar');
    $this->month['02'] = /* translators: month name */ __('Veebruar');
    $this->month['03'] = /* translators: month name */ __('Märts');
    $this->month['04'] = /* translators: month name */ __('Aprill');
    $this->month['05'] = /* translators: month name */ __('Mai');
    $this->month['06'] = /* translators: month name */ __('Juuni');
    $this->month['07'] = /* translators: month name */ __('Juuli');
    $this->month['08'] = /* translators: month name */ __('August');
    $this->month['09'] = /* translators: month name */ __('September');
    $this->month['10'] = /* translators: month name */ __('Oktoober');
    $this->month['11'] = /* translators: month name */ __('November');
    $this->month['12'] = /* translators: month name */ __('Detsember');
